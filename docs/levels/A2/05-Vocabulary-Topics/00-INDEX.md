...
- Before: A1 [05-Vocabulary-Topics](../../A1/05-Vocabulary-Topics/00-INDEX.md) (A1 words stay valid, A2 adds depth)
- After: [06-Daily-Communication](../06-Daily-Communication/00-INDEX.md) (use these words in real talks)
- Supplement: A1 [02-Grammar-Core](../../A1/02-Grammar-Core/00-INDEX.md) Wetter/Wohnen/Kleidung sections stay useful.

## What you can do after this Part

- Handle 12 real situations in German: from Verspätung to Reklamation to Krankmeldung.
