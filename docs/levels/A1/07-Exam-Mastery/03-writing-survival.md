...
| German on form | What it means | Your answer |
|----------------|---------------|-------------|
| Vorname | first name | Hamed |
| Nachname / Familienname | last name | Okhovvat |
| Geburtsdatum | birth date | 21.09.1985 |
| Geburtsort | place of birth | Teheran |
| Geburtsland | country of birth | Iran |
| Adresse / Straße | street | Erika-Mann-Straße 12 |
| Hausnummer | house number | 12 |
| Postleitzahl (PLZ) | postal code | 80636 |
| Wohnort / Stadt | city | München |
| Bundesland | state | Bayern |
| Telefonnummer | phone | 0176 12345678 |
| E-Mail-Adresse | email | hamed@email.de |
| Nationalität | nationality | iranisch |
| Familienstand | marital status | verheiratet |
| Beruf | profession | Softwareentwickler |
| Muttersprache | mother tongue | Persisch |
| Religion | religion | (leave blank or write "keine") |
| Gesundheitszustand | health condition | gesund |
...
| What you write | Correct |
|----------------|---------|
| Nationalität: iranisch | ✅ (adjective form) |
| Nationalität: Iran | ❌ (country, not nationality) |
| Ich komme aus dem Iran. | ✅ (country with article) |
| Ich bin Iraner. | ✅ (noun form, no article) |

### Date format

```
21.09.1985 = 21. September 1985 = einundzwanzigster September neunzehnhundertfünfundachtzig
```

- Day.Month.Year (German format)
- OR write it out: 21. September 1985
- NEVER: 09/21/1985 (American format)

---

## TASK 2: The Message - Mitteilung

### The skeleton (use for EVERY message)

```
[Anrede],
[2-3 Sätze: Situation + Wunsch/Aussage].
[Grußformel]
[Name]
```

### Anrede (Greeting) - pick the right one

| Situation | German | When to use |
|-----------|--------|-------------|
| Friend / peer | **Liebe Anna,** | female friend |
| Friend / peer | **Lieber Thomas,** | male friend |
| Informal group | **Hallo zusammen,** | group of friends |
| Formal / stranger | **Sehr geehrte Damen und Herren,** | official letter |
| Formal (known name) | **Sehr geehrter Herr Weber,** | male authority |
| Formal (known name) | **Sehr geehrte Frau Schmidt,** | female authority |
| Super informal | **Hey,** | close friend (risky in exam) |

### Grußformel (Closing) - pick the right one

| Situation | German | When to use |
|-----------|--------|-------------|
| Friendly (standard) | **Viele Grüße** | most messages |
| Warm | **Liebe Grüße** | friends, family |
| Formal | **Mit freundlichen Grüßen** | official letters |
| Warm + name | **Herzliche Grüße** | close friends |
| Quick | **Bis bald!** | see you soon |
| Quick | **Bis Montag!** | see you Monday |

### Signature

- First name only: **Hamed** (friends)
- Full name: **Hamed Okhovvat** (formal)

---

## THE 7 TEMPLATES (cover 95% of exam tasks)
...
## USEFUL SENTENCES BY CATEGORY

### Date & Time

| German | English |
|--------|---------|
| am Montag / Dienstag / Mittwoch / Donnerstag / Freitag / Samstag / Sonntag | on Monday / Tuesday / Wednesday / Thursday / Friday / Saturday / Sunday |
| am Wochenende | on the weekend |
| um 8 Uhr / um 14 Uhr / um 20 Uhr | at 8 / at 2 PM / at 8 PM |
| morgens / nachmittags / abends | in the morning / afternoon / evening |
| heute / morgen / übermorgen | today / tomorrow / day after tomorrow |
| nächsten Montag / nächsten Samstag | next Monday / next Saturday |
| am 21. September | on September 21st |
| von 9 bis 17 Uhr | from 9 to 5 PM |
...
| Ich lerne für die Prüfung. | I am studying for the exam. |
...
| Ich muss erst fragen. | I have to ask first. |
| Schreib mir bitte zurück. | Please write me back. |
| Antwortest du bitte? | Could you please answer? |
| Schreib mir, ob du kommen kannst. | Write me whether you can come. |
...
| Situation | German |
|-----------|--------|
| Birthday invitation | Ich habe am Samstag Geburtstag. Möchtest du kommen? |
| Can't come | Ich kann leider nicht kommen. Es tut mir leid. |
| Suggest another day | Können wir uns am anderen Tag treffen? |
| Thank for invitation | Vielen Dank für die Einladung! Ich komme gerne. |
| Ask for address | Wie ist deine Adresse? |
| Confirm meeting | Ja, gerne! Wir treffen uns am Montag. |
| Cancel politely | Tut mir leid, ich habe vergessen. Kann ich mich entschuldigen? |
| Accept invitation | Ja, gerne! Ich freue mich darauf. |
| Decline invitation | Danke für die Einladung, aber ich kann leider nicht. |
| Ask for time | Wann fängt es an? |
| Ask for place | Wo treffen wir uns? |
| Ask for details | Wie bitte? Was genau? |
| Say goodbye | Bis bald! / Bis morgen! / Bis Montag! |
| Greet on phone | Hallo, hier ist Hamed. |
| Leave message | Kann ich eine Nachricht hinterlassen? |
| Repeat | Können Sie das bitte wiederholen? |
| Speak slower | Können Sie bitte langsamer sprechen? |
...
| I agree | Ich bin einverstanden. / Ich stimme zu. |
| I disagree | Das sehe ich anders. |
| I'm not sure | Ich bin mir nicht sicher. |
| Maybe later | Vielleicht später. |
| Let's do it | Lass uns das machen! |
...
When you don't know what to write, use these:

| Problem | Solution |
|---------|----------|
| Don't know a word | Use a simpler word or describe it: "Das Ding zum Schreiben" (Stift) |
| Don't know the grammar | Use short simple sentences: "Ich komme nicht. Ich bin krank." |
| Running out of time | Write the closing first: "Viele Grüße, Hamed" then add sentences before |
| Don't understand the prompt | Look for key words: Einladung, Entschuldigung, Dank, Termin |
| Too many mistakes | Cross out and rewrite - don't try to fix every error |
| Don't know the date format | Write: 21. September 1985 (words, not numbers) |

---

## QUICK CHECKLIST (before you hand in)

- [ ] Task 1: Every box filled with your data
- [ ] Task 1: Date format is German (21.09.1985)
- [ ] Task 2: Greeting present (Liebe/Lieber/Sehr geehrte...)
- [ ] Task 2: 2-3 sentences in the body
- [ ] Task 2: Closing present (Viele Grüße / Liebe Grüße)
- [ ] Task 2: Name signed
- [ ] Task 2: 20-30 words (not too long, not too short)
- [ ] All present tense (no past tense needed)
- [ ] Spelling: umlauts (ä, ö, ü) and ß are correct
...
|----------------|------------------|-----|
| Sehr geehrte Damen und Herren, ich habe... | Liebe Anna, ich habe... | "Sehr geehrte" is too formal for friends |
| Ich hatte Geburtstag | Ich habe Geburtstag | Present tense, not past |
| Wir treffen am Montag uns | Wir treffen uns am Montag | Verb at end after time phrase |
| Ich bin krank. Ich komme nicht. | Ich bin krank und kann nicht kommen. | Combine with "und" |
| Liebe Grüße Hamed Okhovvat | Viele Grüße Hamed | Keep it simple and short |
| (empty Task 1 boxes) | Fill every box | Empty = 0 points |

---

## EXERCISE: Write 5 messages right now

**1. Invitation:** Write an invitation to a friend for dinner on Saturday at 7 PM.
**2. Apology:** Write that you can't come to a meeting tomorrow because you're sick.
**3. Thank you:** Thank a friend for a birthday gift.
**4. Meeting:** Suggest meeting a friend on Monday at 3 PM at a café.
**5. Information:** Tell a friend about a party on Friday at 8 PM at your place.
**6. Reply to invitation:** Ihr Freund Ahmed hat Sie am Samstag zu seiner Party eingeladen. Schreiben Sie ihm eine kurze Nachricht: Sie kommen, und Sie bringen einen Salat mit.
**7. Short message:** Schreiben Sie eine kurze Mitteilung an einen Freund.

Write all 7, then check them against the templates above.
