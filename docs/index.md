...
|---|---|---|
| **[Part 01 - Foundations](levels/A1/01-Foundations/00-INDEX.md)** | Numbers, dates, clock time, time words | Own the basics: every price, date, and "halb neun" you ever hear |
| **[Part 02 - Grammar Core](levels/A1/02-Grammar-Core/00-INDEX.md)** | Articles, cases, pronouns, prepositions, negation | The skeleton - der/den/dem, ein/einen/einem, kein vs nicht |
| **[Part 03 - Verbs](levels/A1/03-Verbs/00-INDEX.md)** | Conjugation, modals, tenses, imperative, future | Conjugate anything, build past, give commands |
| **[Part 04 - Sentence Building](levels/A1/04-Sentence-Building/00-INDEX.md)** | Word order, question words, comparative, da/wo | Build correct sentences without guessing |
| **[Part 05 - Vocabulary Topics](levels/A1/05-Vocabulary-Topics/00-INDEX.md)** | Thematic words: family, food, housing, city, health | Words as chunks you can actually say |
...
1. **Start at Part 01** - read the Part index first, then the files in numbered order
2. **Follow the sequence** - each part builds on the previous one
3. **Say things out loud** - listening and speaking beat reading alone
4. **Learn nouns with articles** - always der/die/das, never a bare noun
5. **Use Part 08 daily** - drill sentences, log mistakes, re-test them
6. **Review regularly** - revisit parts to reinforce what you learned

### Study Tips

- **Consistency over intensity** - 30 minutes daily beats 3 hours weekly
- **Active practice** - cover the German, recall English → German, say it out loud
- **Track your progress** - strike through mistakes only after you get them right from memory
- **Speak early, speak often** - imperfect German that flows beats perfect German that stops

## Ready to Begin?

Start your German journey today.

**[Begin with Part 01 - Foundations](levels/A1/01-Foundations/00-INDEX.md)**
or **[go to the Start Here page](levels/A1/index.md)** for the full book map.